...
class KMISPooling(Module):
    ...
    Args:
        ...
        aggr_edge (str): The aggregation function to be applied to the edges
            crossing the same two clusters. Can be any string admitted by
            :obj:`scatter` (e.g., :obj:`'sum'`, :obj:`'mean'`, :obj:`'max'`).
            Defaults to :obj:`'sum'`.
    ...
    def _absolute_mean_curvature(self, x: Tensor, edge_index: Adj,
    ...
    def forward(self, x: Tensor, edge_index: Adj,
            ...
            -> Tuple[Tensor, Adj, OptTensor, OptTensor, OptTensor, Tensor, Tensor]:
        """"""
        adj, n = edge_index, x.size(0)
        ...
        return x, edge_index, edge_attr, pos, batch, mis, cluster
